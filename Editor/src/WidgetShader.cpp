...
void WidgetShader::DebugGLBoolText(const char* Name, GLint value, bool color)
{
	ImGui::Text("%s:", Name);
	ImGui::SameLine();
...
void WidgetShader::DebugShader(GLuint program, GLuint shader)
{
...
void WidgetShader::InspectProgram(GLuint program)
{
